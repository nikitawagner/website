...
const PortfolioGrid = () => {
	...
	return (
		<div className="grid grid-cols-2 md:grid-cols-3 gap-4 p-1 md:p-3">
			...
			<div
				className="bg-primarypastel text-white rounded-md col-span-1 
			...
			<div
				className="bg-primary p-4 text-white rounded-md col-span-2 
				md:col-span-3 text-center text-3xl sm:text-5xl md:text-7xl font-bold 
				flex items-center justify-center flex-wrap
				hover:shadow-[5px_5px_0px_0px_rgba(144,149,252)] hover:cursor-pointer
				transition-all duration-300 hover:scale-101"
